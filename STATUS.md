...
remaining:
  ...
  - publication correction: update the live Workshop description and screenshots after the new runtime pass; declare only Adaptive Storage Framework as required. Existing v1.0.0 and its screenshots describe the superseded Workshop-based code.
