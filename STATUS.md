...
remaining:
  - resolved 2026-09-21 (preTest -> done): the Pickle suite is written in tests/Pickle (20 scenarios, 5 features, 16 @review captures, no step assembly), scope justified in tests/Pickle/README.md and TESTING.md. Run three times in the WSL the same day: first 19 played of 19 written (16 passed, 1 failed on a defect of the suite, 2 skipped as @wip); after the fix, in English, 20 of 20 (18 passed, 0 failed, 2 skipped as @wip), exitReason passed; in French with -IncludeWip, 20 of 20 (20 passed, 0 skipped), exitReason passed. Results: tests/pickle-run-2026-09-21/, -second/, -french/.
  - unverified (done -> tested): what the Pickle suite does not reach. The French pass showed the buildings named correctly in developer mode (Panier en bois, Amas de granite, Socle en vaccolithe...) but not the inspect-pane descriptions, the research tab, blueprints and frames, the piles, shelf and bundle names, or a third-party stone with the Harmony fallback. All 16 @review captures were looked at in English across two runs and the French ones for their labels only; the framing is wide (whole colony in frame), and a person still has to judge them. The manual scenarios 4b, 8, 9 and 10, the logs beyond the Pickle report, a new game and an existing save are not done.
